...
import com.example.mvi_noteapp.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_PENDING
import com.example.mvi_noteapp.business.interactors.common.DeleteNote.Companion.DELETE_NOTE_SUCCESS
import com.example.mvi_noteapp.business.interactors.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_ARE_YOU_SURE
import com.example.mvi_noteapp.framework.datasource.cache.database.NOTE_FILTER_DATE_CREATED
import com.example.mvi_noteapp.framework.datasource.cache.database.NOTE_FILTER_TITLE
import com.example.mvi_noteapp.framework.datasource.cache.database.NOTE_ORDER_ASC
import com.example.mvi_noteapp.framework.datasource.cache.database.NOTE_ORDER_DESC
import com.example.mvi_noteapp.framework.presentation.BaseApplication
import com.example.mvi_noteapp.framework.presentation.UIController
import com.example.mvi_noteapp.framework.presentation.common.BaseNoteFragment
import com.example.mvi_noteapp.framework.presentation.common.hideKeyboard
import com.example.mvi_noteapp.framework.presentation.notedetail.NOTE_DETAIL_SELECTED_NOTE_BUNDLE_KEY
import com.example.mvi_noteapp.framework.presentation.notelist.state.NoteListStateEvent
import com.example.mvi_noteapp.framework.presentation.notelist.state.NoteListStateEvent.*
import com.example.mvi_noteapp.framework.presentation.notelist.state.NoteListToolbarState
import com.example.mvi_noteapp.framework.presentation.notelist.state.NoteListToolbarState.*
import com.example.mvi_noteapp.framework.presentation.notelist.state.NoteListViewState
import com.example.mvi_noteapp.util.TodoCallback
